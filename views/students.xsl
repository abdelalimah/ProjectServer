...
<div class="form-group">
    <label for="exampleFormControlFile1">Entrer votre image</label>
    <input type="file" class="form-control-file" id="exampleFormControlFile1"/>
          ...
          <div class="container">
            ...
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                <h5 class="card-title"><xsl:value-of select="name"/> - <xsl:value-of select="nickname"/></h5>
                <p class="card-text"><xsl:value-of select="age"/></p>
                <p class="card-text">CNE:<xsl:value-of select="@cne"/></p>
                <p class="card-text">CIN:<xsl:value-of select="@cin"/></p>
